...
/** File scope NodeList of all of the sliding pizzas, so we don't have to keep building the list in updatePositions */
var slidingPizzas = {};
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    /** Pulled the following two lines out of the for loop below. It's a waste to calculate them on every iteration. */
    ...
    /** Cache the list of pizza containers and the length of the list to avoid redundant calls. */
    var pizzaContainerList = document.querySelectorAll(".randomPizzaContainer");
    var pizzaContainerListLength = pizzaContainerList.length;
    for (var i = 0; i < pizzaContainerListLength; i++) {
...
function updatePositions() {
  ...
  /** Moved the following line to document.addEventListener and made the variable global */
  //var slidingPizzas = document.querySelectorAll('.mover');

  /** Pulled all of the following out of the loop below to minimize the amount of redundant work
   *  being performed in the loop, especially calculation of transcendental functions. */
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /** Moved this here from updatePositions.  It only needs to be called when the sliding pizzas are created.
   *  The variable is declared at the top of the file.
   * @type {NodeList}
   */
